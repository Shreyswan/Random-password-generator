...
zxcvbn is said to be a very revolutionary way of checking password strength which doesn't rate a password on how many different characters we have in it, however, it rates passwords based on how likely a pattern is to repeat in the password. 🤓
Enjoy a sleek and fun looking UI with the password strength checker!!

More cool stuff is on the way!! Stay tuned!!
